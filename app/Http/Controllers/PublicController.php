...
class PublicController extends Controller
{
    ...
    {
        foreach ($this->programsData() as $p) if ($p['code'] === $code) return $p;
        return null;
    }
    ...
    private function programsData()
    {
        return [
            [
                'code'=>'TPM','slug'=>'teknik-mesin-tp','name'=>'Teknik Pemesinan','short'=>'TP','icon'=>'ti-settings','color'=>'slate','desc'=>'Keterampilan pemesinan, CNC & manufaktur presisi untuk industri mesin.',
            ...
            [
                'code'=>'TGM','slug'=>'teknik-mesin-dgm','name'=>'Desain Gambar Mesin','short'=>'DGM','icon'=>'ti-ruler-measure','color'=>'emerald','desc'=>'Desain & gambar teknik mesin 2D/3D dengan CAD profesional.',
                'tagline'=>'TP & DGM — Program Keahlian Unggulan',
                'about'=>[
            ...
            [
                'code'=>'TKRO','slug'=>'teknik-otomotif','name'=>'Teknik Kendaraan Ringan Otomotif','short'=>'TKR','icon'=>'ti-car','color'=>'red','desc'=>'Perawatan & perbaikan kendaraan ringan modern, EFI & hybrid.',
            ...
            [
                'code'=>'EIND','slug'=>'teknik-elektronika','name'=>'Teknik Elektronika Industri','short'=>'TEI','icon'=>'ti-cpu','color'=>'blue','desc'=>'Penguasaan elektronika industri, PLC, sensor & IoT untuk otomatisasi manufaktur.',
            ...
            [
                'code'=>'MKA','slug'=>'mekatronika','name'=>'Mekatronika','short'=>'MEKA','icon'=>'ti-robot','color'=>'orange','desc'=>'Integrasi mekanik, elektronika & informatika untuk robotika.',
                'tagline'=>'TEI & MEKA — Program Keahlian Unggulan',
                'about'=>[
            ...
            [
                'code'=>'TEKS','slug'=>'teknik-tekstil','name'=>'Teknologi Penyempurnaan Tekstil','short'=>'TPT','icon'=>'ti-shirt','color'=>'amber','desc'=>'Teknologi proses tekstil dari pemintalan hingga finishing.',
                'tagline'=>'Program Keahlian Unggulan',
                'about'=>[
            ...
            [
                'code'=>'TKJ','slug'=>'tjkt','name'=>'Teknik Jaringan Komputer & Telekomunikasi','short'=>'TJKT','icon'=>'ti-network','color'=>'sky','desc'=>'Jaringan fiber optic, server, cloud & keamanan siber.',
            ...
            [
                'code'=>'RPL','slug'=>'pplg','name'=>'Pengembangan Perangkat Lunak & Gim','short'=>'PPLG','icon'=>'ti-code','color'=>'violet','desc'=>'Pengembangan web, mobile & desktop dengan stack modern.',
                'tagline'=>'Program Keahlian Unggulan',
                'about'=>[
            ...
            [
                'code'=>'MM','slug'=>'broadcasting-perfilman','name'=>'Broadcasting dan Perfilman','short'=>'BP','icon'=>'ti-movie','color'=>'pink','desc'=>'Produksi film, broadcasting, sinematografi & editing video profesional.',
                'tagline'=>'Program Keahlian Unggulan',
                'about'=>[
